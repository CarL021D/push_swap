...
/*   Updated: 2022/09/29 21:39:22 by caboudar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		sort_4_and_above(t_stack **stack_a,
...
void		push_presort_to_b(t_stack **stack_a,
				t_stack **stack_b, t_data *data);
...
void		rotate_node_to_1st(t_stack **stack,
				t_stack *node, int size, int id);
void		rr_or_rrr_if_poss(t_stack **stack_a,
				t_stack **stack_b, t_stack *node);
